...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{../figures/fig1_saturation_cliff.pdf}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{../figures/fig2_latency_analysis.pdf}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{../figures/fig3_efficiency.pdf}}
...
% HINT FOR ARCHITECTURAL DIAGRAM
% [Insert Figure 4 here: System Architecture. A diagram showing the three-tier architecture: Application Layer → Adaptive Thread Pool Controller (with Instrumentor, Monitor, and Controller components) → Worker Threads → Python Interpreter with GIL]
...
% HINT FOR ARCHITECTURAL DIAGRAM
% [Insert Figure 5 here: Controller Flow Diagram. A flowchart showing the decision logic: Queue Length Check → Blocking Ratio Check → Scale Up/Down/Veto Decision]
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{../figures/fig4_solution_comparison.pdf}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{../figures/fig5_combined_panel.pdf}}
